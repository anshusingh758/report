...
<html>
<head>
	<title>Client - AmeriHealth</title>
...
<body>
	<section>
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 report-title">Client - AmeriHealth</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-md-offset-2">
					<button type="button" onclick="location.href='<?php echo "index_v1.php"; ?>'" class="form-control months-button dark-button">Data verification status report (V1)</button>
				</div>
				<div class="col-md-3 col-md-offset-2">
					<button type="button" onclick="location.href='<?php echo "index_v2.php"; ?>'" class="form-control months-button dark-button">Data verification status report (V2)</button>
				</div>
				<div class="col-md-2">
