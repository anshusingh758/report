<?php
	...
	if($_POST){
		foreach($_POST["checked_id"] as $key => $value){
			...
			$query[]="INSERT INTO incentive_data(person_id,person_name,type,period,total_candidate,incentive_amount,additional_incentive,final_incentive,adjustment_method,adjustment_amount,adjustment_comment,final_amount,detail_data,addedby) VALUES('$person_id','$person_name','$typedata','$period','$total_candidate','$incentive_amount','$additional_incentive','$final_incentive','$adjustment_method','$adjustment_amount','$adjustment_comment','$final_amount','$detail_data','$user')";
		}
