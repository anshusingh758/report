<?php
	...
	if($_POST){
		foreach($_POST["checked_id"] as $key=>$value){
			...
			$query[]="INSERT INTO incentive_data(person_name,type,period,total_candidate,incentive_amount,bd_total_contract,bd_msp,bd_direct,bd_product_sale,final_incentive,adjustment_method,adjustment_amount,adjustment_comment,final_amount,detail_data,addedby) VALUES('$person_name','$type_data','$period','$total_candidate','$incentive_amount','$bd_total_contract','$bd_msp','$bd_direct','$bd_product_sale','$final_incentive','$adjustment_method','$adjustment_amount','$adjustment_comment','$final_amount','$detail_data','$user')";
		}
