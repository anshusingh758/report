...
<html>
<head>
	<title>Canada Matrix Report</title>
...
<body>
	...
	<section>
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 report-title">Canada Matrix Report</div>
				...
				<div class="row main-section-row">
					<div class="col-md-4 col-md-offset-4">
						...
						<select id="personnel-list" class="<?php if (isset($_REQUEST["personnel-list"])) { echo "customized-selectbox-without-all"; } else { echo "customized-selectbox-with-all"; } ?>" name="personnel-list[]" multiple required>
							<?php
								$isSelected = "";
								$salesGroupPersonnel = salesGroupPersonnelList($sales_connect,"5");
			...
			<div class="row report-bottom-style">
				<div class="col-md-12">
					<table class="table table-striped table-bordered customized-datatable">
						...
						<tbody>
							<?php
								$totalAccounts = $totalContacts = $totalFirstTouch = $totalMeaningfulData = $totalMeetings = $totalShowUps = $totalFollowUps = $totalRegistrationDone = $totalPipeline = $totalWorking = $totalSubmitted = $totalSecondStage = $totalWon = $totalRequirements = $totalGrossProfit = $sowData = array();
								...
								foreach ($fromDate as $fromDateKey => $fromDateValue) {
									...
									(SELECT
										...
										COUNT(DISTINCT CASE WHEN (act.c_registration = 1) THEN act.id END) AS total_registration_done,
							...
							<?php } ?>
								...
								<td>
								<?php
									if ($mainROW["total_registration_done"] == "") {
										echo $totalRegistrationDone[] = "0";
									} else {
										echo $totalRegistrationDone[] = $mainROW["total_registration_done"];
									}
								?>
								</td>
								<td>
						...
						<tfoot>
							...
							<?php } ?>
								...
								<th><?php echo array_sum($totalRegistrationDone); ?></th>
