...
<html>
<head>
	<title>Summary Report Client - Job Date Created</title>
...
<body>
	...
	<section>
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 text-center" style="font-size: 30px;background-color: #aaa;color: #111;padding: 10px;">Summary Report Client - Job Date Created</div>
							...
							<?php
								...
								foreach($fromDate AS $key => $fromDate2){
									...
									(SELECT
									    ...
									    COUNT(job.joborder_id) AS totjob,
									...
									GROUP BY comp.company_id) AS b ON b.cid = a.cid";
									...
									if ($sessionROW['user_type'] == 'CS Manager') {
										...
										$mainQUERY .= " WHERE a.owner = '".$findOwnerROW['user_id']."' GROUP BY a.cid";
									} else {
										$mainQUERY .= " GROUP BY a.cid";
									}
