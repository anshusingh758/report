...
<html>
<head>
	<title>Detail Report Client</title>
...
<body>
	...
	<section>
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 text-center" style="font-size: 30px;background-color: #aaa;color: #111;padding: 10px;">Detail Report Client</div>
								...
								foreach($fromDate AS $key => $fromDate2){
									...
									if ($user == "12") {
										...
										if ($sessionROW['user_type'] == 'CS Manager') {
											...
											$mainQUERY .= " AND comp.owner = '".$findOwnerROW['user_id']."' GROUP BY job.joborder_id";
										} else {
											$mainQUERY .= " GROUP BY job.joborder_id";
										}
									}
