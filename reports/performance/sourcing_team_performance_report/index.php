...
<html>
<head>
	<title>Sourcing Team Performance Report</title>
...
<body>
	...
	<section>
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 report-title">Sourcing Team Performance Report</div>
				...
				<div class="col-md-12">
					<table class="table table-striped table-bordered customized-datatable">
						<thead>
							...
							<?php } ?>
								<th colspan="9">Total No. of</th>
								<th rowspan="2" data-toggle="tooltip" data-placement="top" title="Total GP / Resources Working">Average Margin</th>
								<th rowspan="2" data-toggle="tooltip" data-placement="top" title="Based on Resources Working">Total GP<br>(Per-Hour)</th>
							</tr>
							<tr class="thead-tr-style">
								<th>Pipeline</th>
								<th>Submission</th>
								...
								<th data-toggle="tooltip" data-placement="top" title="Candidate Working">Resources<br>Working</th>
							</tr>
						</thead>
						<tbody>
						<?php
							$totalPipeline = $totalSubmission = $totalInterview = $totalInterviewDecline = $totalOffer = $totalPlaced = $totalExtension = $totalFailedDelivery = $resourcesWorking = $finalActualMargin = array();
							...
							foreach ($fromDate as $fromDateKey => $fromDateValue) {
								...
								$mainQUERY = "SELECT
									a.sourcing_personnel_id,
									a.sourcing_personnel_name,
									b.total_pipeline,
									c.total_submission,
									c.total_interview,
									c.total_interview_decline,
									c.total_offer,
									c.total_failed_delivery,
									d.total_placed,
									e.total_extension,
									f.resources_working
								FROM
								...
								if (mysqli_num_rows($mainRESULT) > 0) {
									while ($mainROW = mysqli_fetch_array($mainRESULT)) {
										...
										$sourcingPersonnelId = $mainROW["sourcing_personnel_id"];
						...
						?>
							<tr class="tbody-tr-style">
								<td><?php echo ucwords($mainROW["sourcing_personnel_name"]); ?></td>
							<?php if (isset($_REQUEST["customized-multiple-month"])) { ?>
