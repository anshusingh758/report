...
<html>
<head>
	<title>Inside Post Sales Performance Report</title>
...
<body>
	...
	<section>
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 report-title">Inside Post Sales Performance Report</div>
								...
								foreach ($fromDate as $fromDateKey => $fromDateValue) {
									...
									if (mysqli_num_rows($mainRESULT) > 0) {
										while ($mainROW = mysqli_fetch_array($mainRESULT)) {
											...
											$personnelType = "'Inside Post Sales'";
