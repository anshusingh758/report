...
<html>
<head>
	<title>Inside Sales Performance Report</title>
...
<body>
	...
	<section>
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 report-title">Inside Sales Performance Report</div>
								...
								foreach ($fromDate as $fromDateKey => $fromDateValue) {
									...
									if (mysqli_num_rows($mainRESULT) > 0) {
										while ($mainROW = mysqli_fetch_array($mainRESULT)) {
											...
											$personnelType = "'Inside Sales Person1','Inside Sales Person2','Research By'";
