...
<html>
<head>
	<title>Onsite Post Sales Performance Report</title>
...
<body>
	...
	<section>
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 report-title">Onsite Post Sales Performance Report</div>
				...
				<div class="row main-section-row">
					<div class="col-md-4 col-md-offset-4">
						...
						<select id="personnel-list" class="customized-selectbox-with-all" name="personnel-list[]" multiple required>
							<?php
								$personnelList = catsExtraFieldPersonnelList($catsConn,"Onsite Post Sales");
								sort($personnelList);
			...
			<div class="row report-bottom-style">
				<div class="col-md-12">
					<table class="table table-striped table-bordered customized-datatable">
						...
						<tbody>
							<?php
								$totalClient = $totalJob = $totalOpenings = $totalZeroSubmission = $totalSubmission = $totalInterview = $totalInterviewDecline = $totalOffer = $totalPlaced = $totalExtension = $totalFailedDelivery = $resourcesWorking = $finalActualMargin = $totalUnansweredJob = $totalUnansweredJobOpenings = array();
								...
								foreach ($fromDate as $fromDateKey => $fromDateValue) {
									...
									WHERE
										ef.field_name = 'Onsite Post Sales'
									AND
									...
									if (mysqli_num_rows($mainRESULT) > 0) {
										while ($mainROW = mysqli_fetch_array($mainRESULT)) {
											...
											$personnelType = "'Onsite Post Sales'";
