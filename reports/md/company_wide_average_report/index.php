...
<html>
<head>
	<title>Company Wide Average Report</title>
...
<body>
	...
	<section>
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 report-title">Company Wide Average Report</div>
							...
							<?php
								$filterBy = array(
									"1" => array(
											"title" => "CS Team",
											"class" => "cs_team",
											"url" => $protocol.REPORT_PATH."/md/company_wide_average_report/cs_team.php"
										),
									"2" => array(
											"title" => "BDC Team",
											"class" => "bdc_team",
											"url" => $protocol.REPORT_PATH."/md/company_wide_average_report/bdc_team.php"
										),
									"3" => array(
											"title" => "BDG Team",
											"class" => "bdg_team",
											"url" => $protocol.REPORT_PATH."/md/company_wide_average_report/bdg_team.php"
										),
									"4" => array(
											"title" => "USBD Team",
											"class" => "usbd_team",
											"url" => $protocol.REPORT_PATH."/md/company_wide_average_report/usbd_team.php"
										),
									"5" => array(
											"title" => "Inside Sales Team",
											"class" => "inside_sales_team",
											"url" => $protocol.REPORT_PATH."/md/company_wide_average_report/inside_sales_team.php"
										),
									"6" => array(
											"title" => "Inside Post Sales Team",
											"class" => "inside_post_sales_team",
											"url" => $protocol.REPORT_PATH."/md/company_wide_average_report/inside_post_sales_team.php"
										),
									"7" => array(
											"title" => "Onsite Sales Team",
											"class" => "onsite_sales_team",
											"url" => $protocol.REPORT_PATH."/md/company_wide_average_report/onsite_sales_team.php"
										),
									"8" => array(
											"title" => "Onsite Post Sales Team",
											"class" => "onsite_post_sales_team",
											"url" => $protocol.REPORT_PATH."/md/company_wide_average_report/onsite_post_sales_team.php"
										),
									"9" => array(
											"title" => "Sourcing Team",
											"class" => "sourcing_team",
											"url" => $protocol.REPORT_PATH."/md/company_wide_average_report/sourcing_team.php"
										),
									"10" => array(
											"title" => "Client Wide Average Report",
											"class" => "client_wide_average_report",
											"url" => $protocol.REPORT_PATH."/md/company_wide_average_report/client_wide_average_report.php"
										)
								);
