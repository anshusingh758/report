...
<html>
<head>
	<title>Quickbook Invoice Report</title>
...
<body>
	...
	<section>
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 report-title">Quickbook Invoice Report</div>
					...
					<table class="table table-striped table-bordered customized-datatable">
						<thead>
							<tr class="thead-tr-style">
								...
								<th>Start Date</th>
								<th>End Date</th>
								<th>Estimated Invoice Generation Date</th>
								<th>Is Invoice Generated?</th>
								<th>Invoice Generation Type</th>
								<th>Actual Invoice Generation Date</th>
								<th>Invoice No.</th>
								<th>Created By</th>
								<th>PDF</th>
							</tr>
