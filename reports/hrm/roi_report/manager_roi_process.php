<?php
	...
	$personnelSalary = $finalArrayValue["personnel_salary"];

	if ($personnelSalary != 0 && $personnelSalary != "") {
        $expectedROI = round(((($personnelSalary * $departmentRate) / 365) * $finalArrayValue["given_days"]), 2);

        $achievedROIPercentage = round((($managerAchievedGpTarget2 / $expectedROI) * 100));
        /*
