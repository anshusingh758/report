<?php
    ...
    $gpQuery = mysqli_query($allConn, "SELECT
        ehd.*,
        IF((si.c_onsite_sales != '' AND si.c_onsite_post_sales = ''), si.c_onsite_sales, IF((si.c_onsite_sales = '' AND si.c_onsite_post_sales != ''), si.c_onsite_post_sales, IF((si.c_onsite_sales != '' AND si.c_onsite_post_sales != ''), CONCAT(si.c_onsite_sales,',',si.c_onsite_post_sales), '---'))) AS shared_with
    FROM
    ...
    WHERE
        (si.c_onsite_sales = '$personnelName' OR si.c_onsite_post_sales = '$personnelName')
    AND
