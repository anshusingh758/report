<?php
	...
	foreach ($weekList as $weekListKey => $weekListValue) {
		...
		if (mysqli_num_rows($mainRESULT) > 0) {
			while ($mainROW = mysqli_fetch_array($mainRESULT)) {
				...
				$personnelArray[$personnelName]["won"][$weekListKey][0] = $totalWon;
				$personnelArray[$personnelName]["won"][$weekListKey][1] = $totalWonDiff;
	...
	foreach ($personnelArray as $personnelArrayKey => $personnelArrayItem) {
		...
		$mail->Subject = $mailSubject = "BDG Matrix || ".ucwords(implode(" ", explode("_", $personnelArrayKey)))." || ".date("m-d-Y (l)", strtotime("today"));
		...
		<body>
			<table style="width: 100%;">
				...
				<tr>
					<td style="font-size: 18px;font-weight: bold;">BDG Matrix Notification || <span style="color: #2266AA;">'.ucwords(implode(" ", explode("_", $personnelArrayKey))).'</span> || <span style="color: #449D44;">'.date("m-d-Y (l)", strtotime('today')).'</span></td>
				</tr>
				<tr>
					<td><br>
						<center>
						<table style="width: 100%;border: 1px solid #ddd;">
							...
							$mailContent.='<tr style="font-size: 15px;">
								...
								if ($personnelArrayItemKey != 'won') {
								$mailContent.='<td style="text-align: center;vertical-align: middle;border-top: 1px solid #ddd;border-right: 1px solid #ddd;">'.$personnelArrayItem[$personnelArrayItemKey]['four_weeks_ago'].'</td>
								...
								$mailContent.='<td style="text-align: center;vertical-align: middle;border-top: 1px solid #ddd;border-right: 1px solid #ddd;position: relative;">'.$personnelArrayItem[$personnelArrayItemKey]['four_weeks_ago'][0].'<div style="font-size: 10px;color: #333;position: absolute;bottom: 0;right: 0;color: #2266AA;font-weight: bold;">'.$personnelArrayItem[$personnelArrayItemKey]['four_weeks_ago'][1].'</div></td>
										<td style="text-align: center;vertical-align: middle;border-top: 1px solid #ddd;border-right: 1px solid #ddd;position: relative;">'.$personnelArrayItem[$personnelArrayItemKey]['three_weeks_ago'][0].'<div style="font-size: 10px;color: #333;position: absolute;bottom: 0;right: 0;color: #2266AA;font-weight: bold;">'.$personnelArrayItem[$personnelArrayItemKey]['three_weeks_ago'][1].'</div></td>
										<td style="text-align: center;vertical-align: middle;border-top: 1px solid #ddd;border-right: 1px solid #ddd;position: relative;">'.$personnelArrayItem[$personnelArrayItemKey]['two_weeks_ago'][0].'<div style="font-size: 10px;color: #333;position: absolute;bottom: 0;right: 0;color: #2266AA;font-weight: bold;">'.$personnelArrayItem[$personnelArrayItemKey]['two_weeks_ago'][1].'</div></td>
										<td style="text-align: center;vertical-align: middle;border-top: 1px solid #ddd;position: relative;">'.$personnelArrayItem[$personnelArrayItemKey]['past_week'][0].'<div style="font-size: 10px;color: #333;position: absolute;bottom: 0;right: 0;color: #2266AA;font-weight: bold;">'.$personnelArrayItem[$personnelArrayItemKey]['past_week'][1].'</div></td>
									</tr>';
								}
							}
							$mailContent.='</tbody>
