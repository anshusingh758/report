<?php
	...
	$personnelData = "'".implode("', '",salesGroupPersonnelList($sales_connect,"4"))."'";
...
/*
				...
				FROM
					...
					LEFT JOIN employmentstatus AS es ON es.id = e.employment_status
...
*/
				...
				$teamArray["won"][$personnelName][$weekListKey] = $totalWon;
	...
	$mail->Subject = $mailSubject = 'Targeted Marketing Matrix || Team || '.date("m-d-Y (l)", strtotime('today'));
	...
	<body>
		<table style="width: 100%;">
			...
			<tr>
				<td style="font-size: 18px;font-weight: bold;">Targeted Marketing Matrix Notification || <span style="color: #2266AA;">Team</span> || <span style="color: #449D44;">'.date("m-d-Y (l)", strtotime('today')).'</span></td>
			</tr>
			<tr>
	...
	// Add a recipient
	$mail->addAddress('simrat.s@vtechsolution.com');
	$mail->addAddress('soudeepya.s@vtechsolution.com');
