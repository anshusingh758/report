<?php
	...
	foreach ($personnelArray as $personnelArrayKey => $personnelArrayItem) {
		...
		$mail->Subject = $mailSubject = "BDC Matrix || ".ucwords(implode(" ", explode("_", $personnelArrayKey)))." || ".date("m-d-Y (l)", strtotime("today"));
		...
		<body>
			<table style="width: 100%;">
				...
				<tr>
					<td style="font-size: 18px;font-weight: bold;">BDC Matrix Notification || <span style="color: #2266AA;">'.ucwords(implode(" ", explode("_", $personnelArrayKey))).'</span> || <span style="color: #449D44;">'.date("m-d-Y (l)", strtotime('today')).'</span></td>
				</tr>
				<tr>
					<td><br>
						<center>
