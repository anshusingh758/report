<?php
	...
	$mail->Subject = $mailSubject = 'US BD Matrix || Team || '.date("m-d-Y (l)", strtotime('today'));
	...
	<body>
		<table style="width: 100%;">
			...
			<tr>
				<td style="font-size: 18px;font-weight: bold;">US BD Matrix Notification || <span style="color: #2266AA;">Team</span> || <span style="color: #449D44;">'.date("m-d-Y (l)", strtotime('today')).'</span></td>
			</tr>
			<tr>
